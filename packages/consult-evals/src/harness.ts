 ...
 *
 * Nothing in this package calls a model. It runs a `ConsultProvider`, which is
...
export class ReleaseGateError extends Error {
  ...
  constructor(readonly report: HarnessReport) {
    ...
    super(
      `Consult eval gate failed. Below ${(RELIABILITY_FLOOR * 100).toFixed(0)}% reliability, ` +
...
export interface ProviderRun {
  ...
  readonly events: readonly ConsultEvent[];
}
