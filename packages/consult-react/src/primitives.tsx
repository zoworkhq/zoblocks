...
export function ConsultRoot(props: { api: ConsultApi; children: ReactNode }): ReactNode {
  ...
  return <ConsultContext.Provider value={props.api}>{props.children}</ConsultContext.Provider>;
}

export function useConsultContext(): ConsultApi {
  const api = useContext(ConsultContext);
  if (!api) {
    throw new Error("useConsultContext must be used inside <ConsultRoot>.");
  }
  return api;
}
 ...
 * having read to them.
 */
export function ConsultLiveRegion(props: { message: string }): ReactNode {
  return (
 ...
 */
export function ConsultAnswerRegion(props: {
  busy: boolean;
  children: ReactNode;
  id?: string;
  className?: string;
 ...
 */
export function ConsultDockRegion(props: {
  label?: string;
  children: ReactNode;
  className?: string;
}): ReactNode {
