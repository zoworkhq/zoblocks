 ...
 * and does not have somewhere to put an `OxygenConsultLogEntry`.
 *
...
const CONSULT_SYSTEM = "https://oxygenui.design/fhir/CodeSystem/consult-audit";
...
export function auditExchange(input: AuditExchangeInput): AuditEvent {
  ...
  return {
    ...
    source: {
      observer: { display: "Oxygen Consult" },
    ...
    agent: [
      {
        ...
        onBehalfOf: { display: `Oxygen Consult (${modelId})` },
      },
    ],
