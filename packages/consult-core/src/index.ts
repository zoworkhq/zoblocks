/**
 * @oxygenui-design/consult-core — the engine behind Oxygen's clinical copilot.
 *
 ...
 *
 *     import { runExchange, lookUp, reduce, initialState } from "@oxygenui-design/consult-core";
 *
