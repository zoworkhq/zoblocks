...
import { PhiNotPermittedError, copilotError, type CopilotError } from "./errors.js";
import type { ClinicalResourceType, FhirResource, Reference } from "./fhir-types.js";
import { readsPatientData, type CopilotMode, type ExclusionCategory } from "./modes.js";
import type { CopilotProvider, CopilotRequest, CopilotTurn, ContextBlock } from "./provider.js";
 ...
 * strip says "2 records withheld" or says nothing, and Copilot renders whichever
...
export interface ResolvedContext {
   ...
   * treatment episode the copilot may not see, Copilot summarises the record
...
export type ContextOutcome =
  ...
  | { readonly ok: false; readonly error: CopilotError };

export async function resolveContext(
  mode: CopilotMode,
  subject: Reference | undefined,
  resolver: CopilotContextResolver | undefined,
  ...
  try {
    ...
    return {
      ok: false,
      error: copilotError("context-unavailable", "The record could not be read.", {
        retryable: true,
        cause,
      }),
    };
