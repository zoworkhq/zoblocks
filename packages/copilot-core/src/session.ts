...
import type { CopilotError } from "./errors.js";
import type { Claim, CopilotEvent, CopilotTurn, Source } from "./provider.js";
...
const TERMINAL: ReadonlySet<CopilotStatus> = new Set<CopilotStatus>(["crisis"]);
...
function applyEvent(state: SessionState, event: CopilotEvent): SessionState {
...
export function toTurns(state: SessionState): readonly CopilotTurn[] {
