...
export function readsPatientData(mode: CopilotMode): boolean {
...
export function defineMode(
  init: Pick<CopilotMode, "id" | "label" | "promptRef" | "risk"> & Partial<CopilotMode>,
): CopilotMode {
  return {
 ...
 */
export const lookUp: CopilotMode = defineMode({
  id: "look-up",
  label: "Look up",
 ...
 */
export const prepare: CopilotMode = defineMode({
  id: "prepare",
  label: "Prepare",
 ...
 */
export const workUp: CopilotMode = defineMode({
  id: "work-up",
  label: "Work up",
 ...
 */
export const defaultModes: readonly CopilotMode[] = [lookUp, prepare];

/** Find a mode by id, or fail loudly. A missing mode is a config bug. */
export function requireMode(modes: readonly CopilotMode[], id: string): CopilotMode {
