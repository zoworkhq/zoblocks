...
export interface ShortcutMenu {
  ...
  readonly items: readonly CopilotShortcut[];
...
export interface UseShortcutMenuOptions {
  ...
  readonly onSelect: (shortcut: CopilotShortcut) => void;
...
export function useShortcutMenu(options: UseShortcutMenuOptions): ShortcutMenu {
  const { shortcuts, draft, role, onSelect, onEscape, idPrefix = "copilot-shortcuts" } = options;
