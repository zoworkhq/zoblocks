...
We as members, contributors, and leaders pledge to make participation in ZoBlocks
UI a harassment-free experience for everyone, regardless of age, body size,
...
## Accessibility is part of conduct here

This project builds interfaces for healthcare. Dismissing an accessibility
concern — in a review, an issue, or a design discussion — is treated as a
conduct matter, not merely a technical disagreement.
...
**conduct@zowork.com**. All complaints will be reviewed and investigated
...
3. **Temporary ban** — a temporary ban from any sort of public interaction.
