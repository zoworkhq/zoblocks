 ...
 * resolved theme onto Oxygen's tokens, and the app does not have a
 ...
 * nothing. What the app does have is their Oxygen theme, and this is what
 ...
 * for MUI's emotion, added to every page in the app for one panel on one
 * screen.
 */
  ...
  return (
    <div
      /*
        ...
        on the app's own surface it would sit on a dark ground in dark mode
