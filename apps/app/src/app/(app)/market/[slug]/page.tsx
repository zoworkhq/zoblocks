...
npx @zoblocks/cli add @zoblocks-pro/${item.slug}`}
        ...
        <Panel
          ...
          description="Payment is taken by Stripe. Card details never reach this app."
        >
          ...
          {/*
            ...
            one paid for against an invoice outside this app. The whole
 ...
 * One checked fact.
 *
 * A word beside every mark, never a bare tick: this app's rule is that
