...
// than by accident. The app renders real Oxygen components in its preview
 ...
 *
 * Not a preference. The app sits one hop from oxygenui.design — a customer
...
export const metadata: Metadata = {
  title: { default: "Theme app — Oxygen UI", template: "%s · Oxygen app" },
  description:
