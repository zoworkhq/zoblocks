...
export async function uploadBrandAssetAction(form: FormData): Promise<ActionResult> {
   ...
   * anything else — a picture this app generated is not a picture this
   * app trusts, and the day somebody posts a `derived` field by hand is
 ...
 * theme manifest route already gives: an app reachable on a vanity domain
