 ...
 *
 * Oxygen ships 28 components and none of them is a Button — ADR 0010 keeps
 * primitives at Ant Design's API and free of any dependency on it. So the
 * honest way to show a reader what Oxygen looks like inside their stack is to
 ...
 * what MUI ships — and Oxygen's reference chrome by default.
 *
...
import { useHost } from "@oxygenui-design/host-react";
...
export function HostChrome() {
  ...
  return (
    <div className="flex flex-col gap-4" data-ox-host-chrome={id}>
