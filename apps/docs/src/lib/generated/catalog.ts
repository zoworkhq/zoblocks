...
export const CATALOG: ComponentDoc[] = [
  {
    ...
    "props": [
      ...
      {
        "name": "activeKey",
        "type": "React.Key | readonly React.Key[] | undefined",
      ...
      {
        "name": "classNames",
        "type": "Partial<Record<AccordionSlot, string>> | undefined",
        "description": "Per-slot class names, matching Ant Design v6's semantic DOM.",
        "required": false
      },
      {
        "name": "collapsible",
        "type": "'header' | 'icon' | 'disabled' | undefined",
      ...
      {
        "name": "density",
        "type": "AccordionDensity | undefined",
      ...
      {
        "name": "expandIcon",
        "type": "((props: { item: AccordionItem; isOpen: boolean; }) => React.ReactNode) | undefined",
      ...
      {
        "name": "locale",
        "type": "Partial<AccordionLocale> | undefined",
      ...
      {
        "name": "styles",
        "type": "Partial<Record<AccordionSlot, React.CSSProperties>> | undefined",
        "description": "Per-slot inline styles, matching Ant Design v6's semantic DOM.",
        "required": false
      },
      {
        "name": "variant",
        "type": "AccordionVariant | undefined",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "readonly React.Key[] | undefined",
  ...
  },
  {
    ...
    "props": [
      ...
      {
        "name": "labels",
        "type": "Partial<SafetyPlanLabels> | undefined",
