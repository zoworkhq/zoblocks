...
export const PRO_FEATURES: readonly ProFeature[] = [
  ...
  },
  {
    ...
    where: "registry/oxygen/lib/accordion.css",
  },
  {
    id: "bridge",
    tab: "Frameworks",
    title: "Oxygen speaks your host’s language",
    body: "A token bridge lets an Oxygen component take the design language of the framework around it — Ant Design, MUI, or neither — without the library ever importing one.",
