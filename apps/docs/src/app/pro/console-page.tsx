 ...
 *
 * ---------------------------------------------------------------------------
 * Not routed right now. Pro is out of the first release, so `page.tsx` renders
 * the holding page instead and this file waits, whole, for the release that
 * puts the console back. Turning it on is two lines there: import `ConsolePage`
 * and return it. Nothing here has been trimmed for storage — a page kept in
 * pieces is a page nobody can switch back on.
 * ---------------------------------------------------------------------------
 */
