...
/**
 * The console's left rail. Navigation, and nothing else.
 *
 * It used to open with a block naming the organisation, the member and their
 * role. That answered "whose console is this", which is a real question on a
  ...
  return (
    <div className="flex h-full flex-col gap-4 lg:gap-6">
      <div className="flex items-center justify-between gap-3">
        <Link
          href="/themes"
          aria-label="Oxygen console home"
      ...
      */}
      ...
      >
        {/*
          ...
          with the email besides. Two blocks answering "whose console is this"
