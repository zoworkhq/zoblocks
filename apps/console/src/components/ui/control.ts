...
export function controlClasses({
  ...
  return cn(
    ...
    //
    // The border goes to `oxygen-deep` rather than `oxygen` because the border
    // is the part carrying the meaning: `oxygen` measures about 2.1:1 against
    ...
    "focus:border-oxygen-deep focus:outline-none focus:ring-[3px] focus:ring-oxygen/20",
