 ...
 * marketing page that falls over when a private console's MongoDB does is a
 * worse property than a page that serves yesterday's catalogue. The failure
 * domains stay separate, and the cache headers below mean a console outage is
  ...
  return NextResponse.json(
    { generatedAt: new Date().toISOString(), items },
    {
      headers: {
         ...
         * this console being down does not take the public pages with it.
         */
