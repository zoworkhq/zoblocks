 ...
 * badge, banner, avatar and patient-chip live in packages the console does not
      ...
      {Specimen ? (
        ...
        <div className="surface p-4">
          ...
          <p className="body-sm mt-1 text-graphite">
            The console can draw {PREVIEWABLE.join(", ")} — the components its own dependencies
            include. The rest live in packages it does not install, and the values below are still
            the ones your application will draw.
          </p>
        </div>
      )}
    </div>
