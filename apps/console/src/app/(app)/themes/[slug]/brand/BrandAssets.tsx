 ...
 *
 * Nothing here is derived. The console does not recolour a mark, invert it, or
 ...
 * page, not a surface of this console — and when it followed the console's
  ...
  return (
    ...
    >
      ...
      <Callout tone="info" title="An SVG is a document, not a picture" className="mt-5">
        ...
        stripped — served from this origin it would run with the console&rsquo;s privileges. Most
        design tools have an export option that omits interactivity; a PNG always works.
      </Callout>
    </Panel>
  );
}
