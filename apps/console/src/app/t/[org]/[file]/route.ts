 ...
 * the console cannot change a running application until somebody moves the pin.
...
export async function GET(
  ...
  const document = {
    ...
    /*
      ...
      the console reached the database, reached the snapshot taken at publish,
  ...
  if (parsed.kind === "json") {
     ...
     *
     * A console reachable on two hostnames — a vanity domain and the one the
