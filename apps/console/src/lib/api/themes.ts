 ...
 * proposes it; the console holds the ramp, the semantic tier and the component
 ...
 *
 * The plugin sends an anchor, not a ramp. The console derives the other ten
 ...
 * decision. ADR 0015 puts the ramp on the console's side of the line; this is
 * where that line is.
 *
 ...
 * a console action by a person with the role for it.
 */
