/**
 * Every app screen, in every theme, against WCAG 2.2 AA.
 *
 * `scripts/a11y.ts` audits the documentation site and derives its page list
 * from the generated catalog. It cannot cover the app: every screen here is
 * behind a session, and a script that signs in would be a second auth
 * implementation to keep working.
 *
 * So the app's audit lives in the Playwright suite instead, where sign-in
