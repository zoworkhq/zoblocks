...
test.describe("@app the catalogue", () => {
 ...
 */
test.describe.serial("@app owning something", () => {
  ...
  test("downloads the pack it owns, and refuses the one it does not", async ({ page }) => {
    ...
    /*
     * The one route in this app that is not public. A miss is a flat 404
...
test.describe("@app access tokens", () => {
