/**
 * The console, end to end, through a browser.
 *
...
test.describe("@console the theme lifecycle", () => {
  test("signs in, edits a token, is refused, fixes it, publishes, and serves it", async ({
    ...
    for (const asset of brand.assets) {
      ...
      // which is not where the artwork lives — fine in the console, useless in
...
test.describe("@console the component tier", () => {
  /**
   ...
   *
   * Only components the console's own dependencies export can be drawn. An
...
test.describe("@console the glyphs", () => {
...
test.describe("@console the broken link that started this", () => {
...
test.describe("@console the theme list", () => {
  /**
  ...
  test("offers a way back when a search matches nothing", async ({ page }) => {
    ...
    // Not the "create your first theme" state — that would be the console
...
test.describe("@console getting from a theme to its screens", () => {
  /**
...
test.describe("@console when there is nothing there", () => {
  /**
   ...
   */
  test("a missing theme keeps you inside the console", async ({ page }) => {
    await signIn(page);
    ...
    // Every one of them, not just the first: the console sets its own
...
test.describe("@console brand artwork", () => {
   ...
   * console generated is not a picture this console trusts.
   */
