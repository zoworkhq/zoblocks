...
export const High: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".zb-risk__head [data-zb-scale='risk']")).toBeTruthy();
    expect(canvasElement.querySelector(".zb-risk__probability")).toHaveTextContent("31");
...
export const Moderate: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(within(canvasElement).getByRole("group").getAttribute("data-zb-band")).toBe("moderate");
  },
};
...
export const Low: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(within(canvasElement).getByRole("group").getAttribute("data-zb-band")).toBe("low");
  },
};
...
export const Expired: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvas.getByRole("group").getAttribute("data-zb-freshness")).toBe("expired");
...
export const Unbounded: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(within(canvasElement).getByRole("group").getAttribute("data-zb-freshness")).toBe(
      "unbounded",
    );
  },
};
...
export const UnweightedDrivers: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".zb-risk__driver-bar")).toBeNull();
    expect(canvasElement.querySelector("[data-zb-unweighted]")).toBeTruthy();
  },
};
...
export const Compact: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(cards[0]?.getAttribute("data-zb-density")).toBe("compact");
