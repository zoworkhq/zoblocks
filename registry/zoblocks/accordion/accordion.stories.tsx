...
import type { AccordionItem } from "@/lib/zoblocks-accordion";
...
export const Closed: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const panel = canvasElement.querySelector(".zb-accordion__panel");
...
export const SummaryInHeader: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    for (const trigger of triggers) {
      expect(trigger.querySelector(".zb-accordion__summary")).not.toBeNull();
    }
  },
};
...
export const Severity: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    for (const severity of ["critical", "high", "normal"]) {
      ...
      expect(item?.querySelector(".zb-accordion__summary")?.textContent?.length).toBeGreaterThan(0);
    }
  },
};
...
export const Nested: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll("h2.zb-accordion__heading")).toHaveLength(1);
    expect(canvasElement.querySelectorAll("h3.zb-accordion__heading")).toHaveLength(2);
  },
};
