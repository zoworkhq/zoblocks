...
import type { AccordionItem, DisclosureEvent } from "@/lib/zoblocks-accordion";
...
describe("ARIA contract", () => {
  ...
  it("uses the heading level it was given", () => {
    ...
    expect(view.container.querySelector("h2.zb-accordion__heading")).not.toBeNull();
    expect(view.container.querySelector("h3.zb-accordion__heading")).toBeNull();
  });
  ...
  it("nests heading levels without flattening the outline", () => {
    ...
    expect(view.container.querySelectorAll("h2.zb-accordion__heading")).toHaveLength(1);
    expect(view.container.querySelectorAll("h3.zb-accordion__heading")).toHaveLength(1);
  });
...
describe("withheld", () => {
  ...
  it("is skipped by expand-all", () => {
    ...
    expect(view.container.querySelector(".zb-accordion__withheld-reason")).not.toBeNull();
  });
});
...
describe("gates", () => {
  ...
  it.each([
    ...
    expect(view.container.querySelector(".zb-accordion__gate")).not.toBeNull();
...
describe("customisation", () => {
  ...
  it("replaces the chevron", () => {
    ...
    expect(view.container.querySelector(".zb-accordion__icon")).toBeNull();
  });
  ...
  it("carries density and icon placement onto the root", () => {
    ...
    expect(root.getAttribute("data-zb-density")).toBe("patient");
  ...
  it("applies per-slot inline styles", () => {
    ...
    expect(
      (view.container.querySelector(".zb-accordion__item") as HTMLElement).style.marginTop,
    ).toBe("1px");
    expect(
      (view.container.querySelector(".zb-accordion__heading") as HTMLElement).style.letterSpacing,
    ).toBe("0.01em");
    expect((triggers(view.container)[0] as HTMLElement).style.columnGap).toBe("3px");
    expect(
      (view.container.querySelector(".zb-accordion__label") as HTMLElement).style.fontWeight,
    ).toBe("700");
    expect((panels(view.container)[0] as HTMLElement).style.zIndex).toBe("1");
    expect(
      (view.container.querySelector(".zb-accordion__inner") as HTMLElement).style.paddingTop,
    ).toBe("2px");
  });
  ...
  it("lets an item override the accordion's slot styles", () => {
    ...
    expect(
      (view.container.querySelector(".zb-accordion__summary") as HTMLElement).style.opacity,
    ).toBe("0.5");
  });
  ...
  it("renders extra content outside the trigger", () => {
    ...
    const extra = view.container.querySelector(".zb-accordion__extra");
    expect(extra).toBeTruthy();
    expect(extra?.closest("button.zb-accordion__trigger")).toBeNull();
  ...
  it("lets an explicit variant win over the antd booleans", () => {
    ...
    expect(
      (view.container.querySelector(".zb-accordion") as HTMLElement).getAttribute("data-variant"),
    ).toBe("separate");
  });
  ...
  it.each(["small", "medium", "large"] as const)("sets the font token for size=%s", (size) => {
    ...
    const root = view.container.querySelector(".zb-accordion") as HTMLElement;
    expect(root.style.getPropertyValue("--zb-accordion-font")).not.toBe("");
  });
