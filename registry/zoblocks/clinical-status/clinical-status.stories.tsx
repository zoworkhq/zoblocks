...
export const Critical: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(chip.querySelector("[data-zb-glyph='alert']")).toBeTruthy();
  },
};
...
export const High: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(chip.querySelector("[data-zb-glyph='caution']")).toBeTruthy();
    expect(chip.getAttribute("data-zb-tone")).toBe("high");
  },
};
...
export const NotAssessed: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(chip.querySelector("[data-zb-glyph='unknown']")).toBeTruthy();
...
export const Preliminary: Story = {
  ...
  play: async ({ canvasElement }) => {
    const chip = within(canvasElement).getByRole("img");
    expect(chip.querySelector("[data-zb-glyph='pending']")).toBeTruthy();
...
export const Restricted: Story = {
  ...
  play: async ({ canvasElement }) => {
    const chip = within(canvasElement).getByRole("img");
    expect(chip.querySelector("[data-zb-glyph='locked']")).toBeTruthy();
    expect(chip.getAttribute("data-zb-tone")).toBe("restricted");
  },
};
...
export const BreakGlass: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(chip.querySelector("[data-zb-glyph='unlocked']")).toBeTruthy();
    expect(chip.getAttribute("data-zb-tone")).toBe("critical");
  },
};
...
export const Stale: Story = {
  ...
  play: async ({ canvasElement }) => {
    const chip = within(canvasElement).getByRole("img");
    expect(chip.querySelector("[data-zb-glyph='stale']")).toBeTruthy();
...
export const SelfReported: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(
      within(canvasElement).getByRole("img").querySelector("[data-zb-glyph='reported']"),
    ).toBeTruthy();
  },
};
...
export const Compact: Story = {
  ...
  play: async ({ canvasElement }) => {
    const chip = within(canvasElement).getByRole("img");
    expect(chip.getAttribute("data-zb-density")).toBe("compact");
  ...
  render: (args) => (
    <ClinicalStatus
      ...
      onExplain={(step) => {
        ...
        const target = document.getElementById("zb-cs-explain");
