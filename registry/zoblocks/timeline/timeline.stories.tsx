...
export const Alternate: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(items[0]?.className).toContain("zb-timeline__item--end");
    expect(items[1]?.className).toContain("zb-timeline__item--start");
  },
};
...
export const Horizontal: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(canvasElement.querySelector("ol")?.className).toContain("zb-timeline--horizontal");
  },
};
...
export const Variants: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(canvasElement.querySelectorAll(".zb-timeline--outlined")).toHaveLength(1);
    expect(canvasElement.querySelectorAll(".zb-timeline--filled")).toHaveLength(1);
  },
};
...
export const Colours: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const nodes = [...canvasElement.querySelectorAll<HTMLElement>(".zb-timeline__node")];
    expect(nodes[0]?.style.color).toContain("--zb-accent");
...
export const LegacyProps: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("ol")?.className).toContain("zb-timeline--start");
    expect(canvasElement.querySelectorAll("li")[1]?.className).toContain("zb-timeline__item--end");
  },
};
