...
export const HighCriticality: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-zb-step='critical']")).toBeTruthy();
...
export const LowCriticality: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const group = within(canvasElement).getByRole("group");
    expect(group.getAttribute("data-zb-criticality")).toBe("low");
    expect(group).toHaveTextContent("Urticaria");
  },
};
...
export const Refuted: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(group.hasAttribute("data-zb-inactive")).toBe(true);
...
export const EnteredInError: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(within(canvasElement).getByRole("group").hasAttribute("data-zb-inactive")).toBe(true);
  },
};
...
export const Unconfirmed: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".zb-allergy__verification")).toHaveTextContent(
      "Unconfirmed",
    );
  },
};
...
export const UnableToAssess: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(canvasElement.querySelector("[data-zb-step='not-assessed']")).toBeTruthy();
  },
};
...
export const Contraindication: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".zb-allergy__kind")).toHaveTextContent("Contraindication");
  },
};
...
export const Compact: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(rows[0]?.getAttribute("data-zb-density")).toBe("compact");
  },
};
