...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll("ol.zb-timeline").length).toBeGreaterThan(1);
  },
};
...
export const InError: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".zb-care-timeline__item--in-error")).not.toBeNull();
  },
};
...
export const NewSinceLastReview: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // floating inside one.
    expect(canvasElement.querySelectorAll("ol.zb-timeline").length).toBeGreaterThan(2);
  },
};
