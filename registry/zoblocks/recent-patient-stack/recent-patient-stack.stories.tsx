...
export const Pinned: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(tabs[0]?.hasAttribute("data-zb-pinned")).toBe(true);
  },
};
...
export const UnsignedNote: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(tab.getAttribute("data-zb-work")).toBe("unsigned-note");
...
export const DraftOrder: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(tab.getAttribute("data-zb-work")).toBe("draft-order");
  },
};
...
export const ClosingWithNote: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(dialog.getAttribute("data-zb-verdict")).toBe("confirm");
...
export const ClosingWithOrder: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const dialog = canvas.getByRole("alertdialog");
    expect(dialog.getAttribute("data-zb-verdict")).toBe("refuse");
