...
export default defineComponentMeta({
  ...
  a11y: [
    ...
    },
    {
      ...
      detail:
        "The target is a pseudo-element sized max(track, --ox-switch-target-min), which follows the density profile. A 26x14px micro switch in a clinical table still presents a 24px-or-larger target.",
    },
    {
  ...
  related: ["clinical-note", "tabs", "clinical-status"],
