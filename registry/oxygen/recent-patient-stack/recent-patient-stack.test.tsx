...
describe("closing", () => {
  ...
  it("asks before losing a draft, and only closes when told to", async () => {
    ...
    expect(dialog).toHaveAttribute("data-ox-verdict", "confirm");
  ...
  it("offers no way through a refusal", async () => {
    ...
    const dialog = screen.getByRole("alertdialog");
    expect(dialog).toHaveAttribute("data-ox-verdict", "refuse");
...
describe("partial charts", () => {
  ...
  it("takes initials from a single-word name without inventing a second letter", () => {
    ...
    expect(container.querySelector(".ox-stack__avatar")).toHaveTextContent("P");
  });
  ...
  it("draws an empty avatar rather than throwing on a chart with a blank name", () => {
    ...
    expect(container.querySelector(".ox-stack__avatar")).toHaveTextContent("");
    expect(container.querySelectorAll(".ox-stack__tab")).toHaveLength(1);
  });
  ...
  it("renders a chart with no reason and no work", () => {
    ...
    expect(container.querySelector(".ox-stack__reason")).toBeNull();
    expect(container.querySelector(".ox-stack__work")).toBeNull();
  });
  ...
  it("shows the identifier in the panel for a similar pair, and not otherwise", () => {
    ...
    const panel = container.querySelector(".ox-stack__panel");
  ...
  it("renders a panel row with no actions when the host wired none", () => {
    ...
    expect(container.querySelector(".ox-stack__panel")).not.toBeNull();
    expect(container.querySelectorAll(".ox-stack__action")).toHaveLength(0);
  });
  ...
  it("says nothing about owed work when nothing is owed", () => {
    ...
    expect(container.querySelector(".ox-stack__owed")).toBeNull();
  });
