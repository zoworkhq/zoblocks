        ...
        {(trigger) => (
          <div
            ...
            style={{
              ...
              borderRadius: "var(--ox-radius, 6px)",
          ...
          >
            ...
            <span style={{ fontSize: "0.75rem", color: "var(--ox-text-subtle, #94a3b8)" }}>
              {args.subject.detail}
            </span>
          </div>
        )}
      </ChartContextMenu>
      <p style={{ margin: 0, fontSize: "0.75rem", color: "var(--ox-text-muted, #64748b)" }}>
...
export const RoutineOnly: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(menu.querySelectorAll(".ox-menu__separator").length).toBe(0);
