...
export const FallingAndImproving: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(figure.getAttribute("data-ox-judgement")).toBe("better");
  },
};
...
export const RisingAndWorsening: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-direction='rising']")).toBeTruthy();
  },
};
...
export const Neutral: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(within(canvasElement).getByRole("figure").getAttribute("data-ox-judgement")).toBe(
      "unknown",
    );
  },
};
...
export const WithinNoise: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(figure.hasAttribute("data-ox-noise")).toBe(true);
...
export const AssayChange: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll(".ox-trend__line")).toHaveLength(2);
...
export const TwoPoints: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-trend__chart")).toBeNull();
...
export const ReferenceBand: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-trend__band")).toBeTruthy();
  },
};
...
export const Narrow: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-trend__chart")).toBeNull();
    expect(canvasElement.querySelector(".ox-trend__readout")).toBeTruthy();
  },
};
...
export const SixtyPoints: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll(".ox-trend__line")).toHaveLength(1);
