...
export const Available: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-ring='solid']")).toBeTruthy();
  },
};
...
export const InSession: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(group.getAttribute("data-ox-dnd")).toBe("");
  },
};
...
export const InGroup: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(button.getAttribute("data-ox-escalation")).toBe("override-required");
...
export const OnCrisisLine: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-ring='pulse']")).toBeTruthy();
  },
};
...
export const OffShift: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-ring='none']")).toBeTruthy();
...
export const Unknown: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-ring='dotted']")).toBeTruthy();
  },
};
...
export const CoverageGap: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(alert.getAttribute("data-ox-coverage")).toBe("gap");
...
export const ViewingOnly: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll(".ox-presence__avatar")).toHaveLength(4);
