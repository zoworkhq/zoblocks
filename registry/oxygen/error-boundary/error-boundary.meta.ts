...
export default defineComponentMeta({
  ...
  description:
    "Contains a failure to one section and never renders a partial record as a complete one. Reports without PHI, and marks boundaries whose failure invalidates the surrounding screen.",
  rationale:
