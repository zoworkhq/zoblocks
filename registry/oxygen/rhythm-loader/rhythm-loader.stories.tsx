...
export const Indeterminate: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-loader__beat")).toBeNull();
  },
};
...
export const Inline: Story = {
  ...
  play: async ({ canvasElement }) => {
    const root = canvasElement.querySelector<HTMLElement>("[data-ox-loader]");
    // The stroke stops thinning below 28px so the trace survives at 20px.
    expect(root?.style.getPropertyValue("--ox-loader-stroke")).toBe("2px");
  },
};
