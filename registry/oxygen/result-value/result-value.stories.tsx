...
export const CriticalWithDelta: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-direction='up']")).toBeTruthy();
...
export const Corrected: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const struck = canvasElement.querySelector(".ox-rv__superseded s");
...
export const DeltaSuppressed: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-rv__delta")).toBeNull();
...
export const PatientReported: Story = {
  ...
  play: async ({ canvasElement }) => {
    expect(canvasElement.querySelector("[data-ox-provenance='patient-reported']")).toBeTruthy();
    expect(within(canvasElement).getByRole("group").getAttribute("aria-label")).toContain(
      "patient-reported",
    );
  },
...
export const AiExtracted: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-provenance='ai-extracted']")).toBeTruthy();
  },
};
...
export const Masked: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(group.getAttribute("data-ox-absent")).toBe("masked");
