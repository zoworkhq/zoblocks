...
const provider = (events: ConsultEvent[], phiPermitted = false) =>
...
const meta: Meta<typeof Consult> = {
  title: "Patterns/Consult",
  component: Consult,
  args: {
...
export default meta;
type Story = StoryObj<typeof Consult>;
...
export const Streaming: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const canvas = within(canvasElement);
    await waitFor(() => expect(canvas.getByRole("complementary")).toBeTruthy());
  },
};
