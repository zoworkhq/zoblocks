...
export default defineComponentMeta({
  ...
  description:
    "Renders the absence of a clinical value as a statement rather than a blank. Distinguishes not-asked, declined, masked, pending, and error — reasons that mean different things and must not share a dash.",
  rationale:
