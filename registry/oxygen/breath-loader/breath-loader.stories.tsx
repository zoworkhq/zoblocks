...
export const Indeterminate: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll(".ox-loader__ring")).toHaveLength(3);
...
export const WithBrandMark: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-loader__mark")).not.toBeNull();
    expect(canvasElement.querySelector(".ox-loader__core")).toBeNull();
    expect(canvasElement.querySelector(".ox-loader__art")?.getAttribute("aria-hidden")).toBe(
      "true",
    );
  },
};
