...
export const HomeDevice: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector("[data-ox-staleness='stale']")).toBeTruthy();
  },
};
...
export const Stale: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const age = canvasElement.querySelector("[data-ox-staleness='stale']");
...
export const DocumentVintage: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelector(".ox-prov__age")).toHaveTextContent("7 mo");
  },
};
